...
public class ItemAdaptor extends ArrayAdapter<Merchandise> {
    public ItemAdaptor(@NonNull Context context, int resource, int textViewResourceId, @NonNull Merchandise[] objects) {
        super(context, resource, textViewResourceId, objects);
    }

    private View populateView(View view, int position){
        Merchandise item = this.getItem(position);
